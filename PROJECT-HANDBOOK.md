...
|---|---|---|---|---|---|
| `sf` | 私房 TV | 影视 / cinema | — | 新增待接入 | 已加入门户 NODE 01，使用参考站当前公开预览图、NEW/直连/PENDING 外观；没有真实独立上游前不接同类替代 provider。 |
| `98` | 98堂 | 影视 / cinema | — | 新增待接入 | 已加入门户 NODE 02，使用参考站当前公开预览图、NEW/直连/PENDING 外观；没有真实独立上游前不接同类替代 provider。 |
